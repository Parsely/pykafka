...
class TestFetchAPI(unittest2.TestCase):
    def test_request(self):
        ...
        self.assertEqual(
            msg,
            bytearray(b'\x00\x00\x00;\x00\x01\x00\x01\x00\x00\x00\x00\x00\x07pykafka\xff\xff\xff\xff\x00\x00\x03\xe8\x00\x00\x04\x00\x00\x00\x00\x01\x00\x04test\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x10\x00\x00')
        )
