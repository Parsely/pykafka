...
class TestMetadataAPI(unittest2.TestCase):
    def test_request(self):
        ...
        self.assertEqual(
            msg,
            bytearray(b'\x00\x00\x00\x15\x00\x03\x00\x01\x00\x00\x00\x00\x00\x07pykafka\x00\x00\x00\x00')
        )
...
class TestProduceAPI(unittest2.TestCase):
    ...
    def test_request(self):
        ...
        self.assertEqual(
            msg,
            bytearray(b"\x00\x00\x00a\x00\x00\x00\x01\x00\x00\x00\x00\x00\x07pykafka\x00\x01\x00\x00\'\x10\x00\x00\x00\x01\x00\x04test\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x004\xff\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00(\x0e\x8a\x19O\x00\x00\x00\x00\x00\x04asdf\x00\x00\x00\x16this is a test message")
        )
...
class TestFetchAPI(unittest2.TestCase):
    def test_request(self):
        ...
        self.assertEqual(
            msg,
            bytearray(b'\x00\x00\x00;\x00\x01\x00\x01\x00\x00\x00\x00\x00\x07pykafka\xff\xff\xff\xff\x00\x00\x03\xe8\x00\x00\x04\x00\x00\x00\x00\x01\x00\x04test\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x04\xb0\x00')
        )
...
class TestOffsetAPI(unittest2.TestCase):
    def test_request(self):
        ...
        self.assertEqual(
            msg,
            bytearray(b'\x00\x00\x003\x00\x02\x00\x01\x00\x00\x00\x00\x00\x07pykafka\xff\xff\xff\xff\x00\x00\x00\x01\x00\x04test\x00\x00\x00\x01\x00\x00\x00\x00\xff\xff\xff\xff\xff\xff\xff\xff\x00\x00\x00\x01')
        )
