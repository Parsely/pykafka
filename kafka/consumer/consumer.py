...
from kafka.consumer.partitions import PartitionOwnerRegistry
from kafka.exceptions import (KafkaException, NoAvailablePartitionsError,
...
class Consumer(object):
    ...
    def __init__(self,
        ...
        :type topic: :class:`kafka.topics.Topic`.
        ...
        :rtype: :class:`kafka.consumer.consumer.Consumer`
        """
