...
class OwnedPartition(BasePartition):
    ...
    def __init__(self,
        ...
        :type partition: :class:`kafka.partitions.Partition`.
...
class PartitionOwnerRegistry(object):
    ...
    def __init__(self,
        ...
        :type consumer: :class:`kafka.consumer.Consumer`.
        :param cluster:
    ...
    def remove(self, partitions):
        ...
        :type partitions: iterable of :class:`kafka.partitions.Partition`.
        """
        for p in partitions:
